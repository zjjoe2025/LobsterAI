...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    mcpCategoryAll: '全部',
    mcpCategoryFilesystem: '文件系统',
    mcpCategorySearch: '搜索',
    mcpCategoryBrowser: '浏览器',
    mcpCategoryDatabase: '数据库',
    mcpCategoryDeveloper: '开发工具',
    mcpCategoryProductivity: '效率工具',
    mcpCategoryDataApi: '数据 & API',
    mcpCategoryMemory: '记忆',
    mcpCategoryReasoning: '推理',
    mcpCategoryCloud: '云平台',
    mcpDesc_filesystem: '安全的文件操作：读写、搜索、移动和目录树浏览',
    mcpDesc_brave_search: '通过 Brave Search API 进行网页、新闻、图片搜索',
    mcpDesc_tavily: '实时网页搜索、智能数据提取和网站爬取',
    mcpDesc_puppeteer: '基于 Puppeteer 的浏览器自动化：导航、截图、表单填写',
    mcpDesc_playwright: '高级浏览器自动化，支持 Chromium/Firefox/WebKit',
    mcpDesc_postgres: '只读 PostgreSQL 数据库访问，支持 Schema 检查和 SQL 查询',
    mcpDesc_sqlite: 'SQLite 数据库交互：读写查询、表管理和数据分析',
    mcpDesc_redis: 'Redis 键值存储操作：获取、设置、删除和列出键',
    mcpDesc_git: 'Git 仓库操作：status、diff、commit、log、branch 等',
    mcpDesc_github: 'GitHub 平台集成：仓库、Issues、PR、Actions 管理',
    mcpDesc_gitlab: 'GitLab API 集成：项目管理、合并请求、流水线',
    mcpDesc_docker: '管理 Docker 容器、镜像、卷和网络',
    ...
    mcpDesc_google_maps: '地理编码、地点搜索、距离计算和路线规划',
    mcpDesc_sentry: '从 Sentry.io 获取和分析错误追踪信息',
    mcpDesc_memory: '基于本地知识图谱的持久化记忆：实体、关系和观察',
    mcpDesc_sequential_thinking: '结构化思维推理：支持分支、修正和假设验证',
    mcpDesc_cloudflare: '部署和管理 Cloudflare Workers、KV、R2、D1 等资源',
  ...
  en: {
    ...
    mcpCategoryAll: 'All',
    mcpCategoryFilesystem: 'Filesystem',
    mcpCategorySearch: 'Search',
    mcpCategoryBrowser: 'Browser',
    mcpCategoryDatabase: 'Database',
    mcpCategoryDeveloper: 'Dev Tools',
    mcpCategoryProductivity: 'Productivity',
    mcpCategoryDataApi: 'Data & API',
    mcpCategoryMemory: 'Memory',
    mcpCategoryReasoning: 'Reasoning',
    mcpCategoryCloud: 'Cloud',
    mcpDesc_filesystem: 'Secure file operations: read, write, search, move and directory tree browsing',
    mcpDesc_brave_search: 'Web, news, and image search via Brave Search API',
    mcpDesc_tavily: 'Real-time web search, intelligent data extraction and web crawling',
    mcpDesc_puppeteer: 'Browser automation with Puppeteer: navigation, screenshots, form filling',
    mcpDesc_playwright: 'Advanced browser automation supporting Chromium/Firefox/WebKit',
    mcpDesc_postgres: 'Read-only PostgreSQL database access with schema inspection and SQL queries',
    mcpDesc_sqlite: 'SQLite database interaction: read/write queries, table management and analytics',
    mcpDesc_redis: 'Redis key-value store operations: get, set, delete and list keys',
    mcpDesc_git: 'Git repository operations: status, diff, commit, log, branch and more',
    ...
    mcpDesc_docker: 'Manage Docker containers, images, volumes and networks',
    ...
    mcpDesc_google_maps: 'Geocoding, place search, distance calculation and route planning',
    mcpDesc_sentry: 'Retrieve and analyze error tracking information from Sentry.io',
    mcpDesc_memory: 'Persistent memory via local knowledge graph: entities, relations and observations',
    mcpDesc_sequential_thinking: 'Structured reasoning: branching, revision and hypothesis verification',
    mcpDesc_cloudflare: 'Deploy and manage Cloudflare Workers, KV, R2, D1 and more',
